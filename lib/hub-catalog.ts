...
const TOOL_CATALOG: CatalogTool[] = [
  ...
  { name: "Cursor", description: "AI-native code editor. Autocomplete, chat, and code generation built into your IDE.", url: "https://cursor.sh", icon_url: "https://cursor.sh/favicon.ico", categories: ["ai_coding", "developer_tools"], tech_stack_tags: ["backend", "frontend"], interest_tags: ["AI Coding Tools"], roles: ["engineering", "data"], audience_level: ["intermediate", "advanced", "expert"] },
  { name: "Perplexity", description: "AI-powered search engine. Get sourced answers to complex research questions with citations.", url: "https://perplexity.ai", icon_url: "https://www.perplexity.ai/favicon.ico", categories: ["research", "search"], tech_stack_tags: [], interest_tags: ["LLMs & Prompting", "Data & Analytics"], roles: ["marketing", "product_management", "sales", "executive", "data"], audience_level: ["beginner", "intermediate", "advanced"] },
  { name: "NotebookLM", description: "Google's AI research assistant. Upload documents and have AI synthesize, summarize, and answer questions.", url: "https://notebooklm.google.com", icon_url: "https://www.gstatic.com/lamda/images/notebooklm_favicon_v2_128.png", categories: ["research", "knowledge_management"], tech_stack_tags: [], interest_tags: ["Data & Analytics", "LLMs & Prompting"], roles: ["product_management", "marketing", "data", "executive"], audience_level: ["beginner", "intermediate"] },
  { name: "n8n", description: "Open-source workflow automation. Connect APIs, databases, and AI models with a visual builder.", url: "https://n8n.io", icon_url: "https://n8n.io/favicon.ico", categories: ["automation", "integration"], tech_stack_tags: ["devops"], interest_tags: ["AI Agents & Automation"], roles: ["engineering", "data", "marketing"], audience_level: ["intermediate", "advanced"] },
  { name: "Zapier", description: "No-code automation platform. Connect 6,000+ apps and trigger AI workflows without writing code.", url: "https://zapier.com", icon_url: "https://zapier.com/favicon.ico", categories: ["automation", "integration", "no_code"], tech_stack_tags: [], interest_tags: ["AI Agents & Automation"], roles: ["marketing", "sales", "hr", "product_management"], audience_level: ["beginner", "intermediate"] },
  { name: "Supabase", description: "Open-source Firebase alternative. Postgres database, auth, storage, and realtime subscriptions.", url: "https://supabase.com", icon_url: "https://supabase.com/favicon/favicon-32x32.png", categories: ["database", "backend", "developer_tools"], tech_stack_tags: ["databases", "backend"], interest_tags: ["AI Coding Tools"], roles: ["engineering", "data"], audience_level: ["intermediate", "advanced", "expert"] },
  { name: "Apollo", description: "Sales intelligence platform. Prospect, enrich, and automate outreach with AI-powered data.", url: "https://apollo.io", icon_url: "https://apollo.io/favicon.ico", categories: ["sales_intelligence", "data_enrichment"], tech_stack_tags: ["marketing_analytics"], interest_tags: ["AI for Business/GTM", "Data & Analytics"], roles: ["sales", "marketing", "executive"], audience_level: ["beginner", "intermediate"] },
  { name: "Granola AI", description: "AI meeting notes. Automatically transcribes, summarizes, and extracts action items from your calls.", url: "https://granola.ai", icon_url: "https://granola.ai/favicon.ico", categories: ["meeting_notes", "productivity"], tech_stack_tags: [], interest_tags: ["AI Agents & Automation"], roles: ["product_management", "sales", "executive", "marketing"], audience_level: ["beginner", "intermediate"] },
  { name: "GPT for Sheets", description: "Run AI prompts in Google Sheets. Batch process data enrichment, classification, and generation.", url: "https://gptforwork.com", icon_url: "https://gptforwork.com/favicon.ico", categories: ["spreadsheet_ai", "data_processing"], tech_stack_tags: [], interest_tags: ["Data & Analytics", "AI for Business/GTM"], roles: ["marketing", "data", "sales", "finance"], audience_level: ["beginner", "intermediate"] },
  { name: "Lovable", description: "AI-powered full-stack app builder. Describe what you want, get a working web app.", url: "https://lovable.dev", icon_url: "https://lovable.dev/favicon.ico", categories: ["ai_coding", "no_code"], tech_stack_tags: ["frontend"], interest_tags: ["AI Coding Tools"], roles: ["product_management", "marketing", "engineering"], audience_level: ["beginner", "intermediate"] },
  { name: "Playwright", description: "Microsoft's browser automation framework. End-to-end testing and web scraping with AI assistance.", url: "https://playwright.dev", icon_url: "https://playwright.dev/img/playwright-logo.svg", categories: ["testing", "automation", "developer_tools"], tech_stack_tags: ["frontend", "devops"], interest_tags: ["AI Coding Tools"], roles: ["engineering"], audience_level: ["advanced", "expert"] },
  { name: "SerpAPI", description: "Google search results API. Programmatic access to search results for market research and data collection.", url: "https://serpapi.com", icon_url: "https://serpapi.com/favicon.ico", categories: ["data_collection", "api"], tech_stack_tags: [], interest_tags: ["Data & Analytics"], roles: ["engineering", "data", "marketing"], audience_level: ["intermediate", "advanced"] },
  ...
  { name: "Microsoft Clarity", description: "Free web analytics with AI insights. Heatmaps, session recordings, and user behavior analysis.", url: "https://clarity.microsoft.com", icon_url: "https://clarity.microsoft.com/favicon.ico", categories: ["analytics", "ux_research"], tech_stack_tags: ["marketing_analytics"], interest_tags: ["Data & Analytics", "AI for Business/GTM"], roles: ["marketing", "product_management"], audience_level: ["beginner", "intermediate"] },
  { name: "Manus AI", description: "Autonomous AI agent for complex multi-step tasks. Research, code, and build entire projects.", url: "https://manus.im", icon_url: "https://manus.im/favicon.ico", categories: ["ai_agent", "automation"], tech_stack_tags: ["ai_ml"], interest_tags: ["AI Agents & Automation"], roles: ["engineering", "product_management", "executive"], audience_level: ["intermediate", "advanced"] },
];
